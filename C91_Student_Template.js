...
function my_keydown(e){
	...
	if(keyPressed == '40')
	{car1_down; console.log("down")};

	if(keyPressed == '39')
	{car1_down; console.log("right")};

	if(keyPressed == '37')
	{car1_left; console.log("left")};

	if(keyPressed == '65')
	{car2_left; console.log("left")};

	if(keyPressed == '87')
	{car2_up; console.log("up")};

	if(keyPressed == '83')
	{car2_down; console.log("down")};

	if(keyPressed == '68')
	{car2_right; console.log("right")};
}
